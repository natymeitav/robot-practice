...
public class Constants {
    ...
    public static class Drivetrain {
        ...
        public static final double TRACK_WIDTH = 0.6649;
    ...
    public static class Autonomous {
        ...
        public static final double leftkS = 0.36;
        public static final double leftkV = 1.6;
        public static final double leftkA = 0.05;
...
//        public static final Pose2d BLUE_INNER_POWER_PORT_LOCATION = new Pose2d(-0.78, 5.79, new Rotation2d()); // The opponent location is (x: -0.78, y: 2.4).
    ...
    public static class Conveyor {
        ...
        public static final double CONVEYOR_SMART_FEED_POWER = 0.5;
